...
class salt::minion (
  ...
  $minion_minion_always_verify_signature = $salt::params::minion_always_verify_signature,) inherits salt::params {
  ...
  Anchor['salt::minion::begin'] -> Class['::salt::minion::install'] -> Class['::salt::minion::config'] ~> Class['::salt::minion::service'
    ] -> Anchor['salt::minion::end']
